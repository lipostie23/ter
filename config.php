...
$config = [
     ...
     * Зачисление доната.
     *
     *  player_table     — таблица игроков (та, в которую пишет игровой мод).
     *  player_nick_col  — колонка с ником.
     *  donate_col       — колонка-копилка доната, куда платежный webhook добавляет монеты.
     */
    'players' => [
